...
using ExitGames.Client.Photon;
    ...
    public class ErrorCode
    {
        ...
        /// In PUN, wait until AnimState is: JoinedLobby (with AutoJoinLobby = true) or ConnectedToMaster (AutoJoinLobby = false)
        /// </remarks>
    ...
    public class EventCode
    {
        ...
        /// <summary>(228) Currently not used. AnimState of queueing in case of server-full</summary>
