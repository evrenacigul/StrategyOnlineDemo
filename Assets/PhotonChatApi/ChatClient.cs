...
namespace Photon.Chat
{
    ...
    public class ChatClient : IPhotonPeerListener
    {
        ...
        /// AnimState ChatUserStatus.Invisible will make you offline for everyone and send no message.
        ///
                    ...
                    else
                    {
                        if (!this.didAuthenticate)
                        {
                            ...
                            if (!this.didAuthenticate)
                            {
                                if (this.DebugOut >= DebugLevel.ERROR)
                                {
                                    ((IPhotonPeerListener)this).DebugReturn(DebugLevel.ERROR, "Error calling OpAuthenticate! Did not work. Check log output, AuthValues and if you're connected. AnimState: " + this.State);
                                }
                            }
                        }
                    }
